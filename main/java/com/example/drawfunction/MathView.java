...
public class MathView extends View {
    ...
    public MathView(Context context,double k, double b) {
        this(context, null,k,b);

    }

    public MathView(Context context, @Nullable AttributeSet attrs,double k,double b) {
