...
public class HelpDraw {
     ...
     * 绘制网格
     */
    public static Picture getGrid(Context context,int step) {
        return getGrid(getWinSize(context),step);
    }
     ...
     * @param winSize 屏幕尺寸
     */
    private static Picture getGrid(Point winSize,int step) {

        Picture picture = new Picture();
        Canvas recording = picture.beginRecording(winSize.x, winSize.y);
        Paint paint = getHelpPint();

        recording.drawPath(HelpPath.gridPath(step, winSize), paint);
        return picture;
...
//        recording.drawLine(coo.x, winSize.y, coo.x + 20, winSize.y - 40, paint);
    ...
    private static void drawText4Coo(Canvas canvas, Point coo, Point winSize, Paint paint) {
        ...
        canvas.drawText("y",   coo.x-60, 40,paint);
        paint.setTextSize(25);
//        //X正轴文字
//        for (int i = 0; i < (winSize.x - coo.x); i+=90) {
//            paint.setStrokeWidth(2);
//            canvas.drawText( i/360.f + "π", coo.x - 20 + 100 * i, coo.y + 40, paint);
//            paint.setStrokeWidth(5);
//            canvas.drawLine(coo.x + 100 * i, coo.y, coo.x + 100 * i, coo.y - 10, paint);
//        }
//
//        //X负轴文字
//        for (int i = 1; i < coo.x / 90; i++) {
//            paint.setStrokeWidth(2);
//            canvas.drawText(-100 * i/360.f + "π", coo.x - 20 - 100 * i, coo.y + 40, paint);
//            paint.setStrokeWidth(5);
//            canvas.drawLine(coo.x - 100 * i, coo.y, coo.x - 100 * i, coo.y - 10, paint);
//        }
